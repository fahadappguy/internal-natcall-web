...
export default function EmailVerifiedPage() {
  return (
    <main className="relative isolate min-h-[100svh] overflow-hidden px-4 py-10 sm:px-6 sm:py-14 lg:px-8">
      ...
      <section className="mx-auto flex min-h-[calc(100svh-80px)] w-full max-w-[920px] items-center justify-center sm:min-h-[calc(100svh-112px)]">
        <Reveal>
